...
\frame{\tableofcontents[currentsubsection]}
	...
	\begin{frame}
		\begin{pbmr}[label=Tsirelsonproof]
			...
			For the hard direction look at the second part of the proof of $\QC_{m,n} = \{(\sclr{x_i}{y_j})_{1\leq i\leq m, 1\leq j \leq n} \,| \, x_i,y_j \in \mathbb{R}^{\min\{m,n\}}, \modul{x_i}\leq 1, \modul{y_j}\leq 1\}$ (\hyperlink{Tsirelson2<3>}{\beamerreturnbutton{Lemma}}).
